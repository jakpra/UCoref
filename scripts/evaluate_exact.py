...
print('fuzzy', al_m, f'{(ex_m*100/al_m) if al_m else 0:.1f}', '-', sep=' & ', end=' \\\\\\hline\n')
...
print('fuzzy', al_r, f'{(ex_r*100/al_r) if al_r else 0:.1f}', '-', sep=' & ', end=' \\\\\\hline\n')
